    ...
    <div class="team-section">
      ...
      <div class="team-members">
        <div class="team-member">
          <img src="/img/nhanvien.jpg" alt="Team Member 1" class="team-img" />
          <h4>Nguyễn Văn A</h4>
          <p>CEO & Nhà sáng lập</p>
        </div>
        <div class="team-member">
          <img src="/img/nhanvien.jpg" alt="Team Member 2" class="team-img" />
          <h4>Trần Thị B</h4>
          <p>Giám đốc điều hành</p>
        </div>
        <div class="team-member">
          <img src="/img/nhanvien.jpg" alt="Team Member 3" class="team-img" />
          <h4>Phan Văn C</h4>
